...
/**
 * Visitor that traverses a CommonMark AST(Abstract Syntax Tree) to extract cards.
 * <p>
 * The visitor collects card content based on headings:
 * <ul>
 *   <li>Text before the first heading becomes a card with the file name as front.</li>
 *   <li>Each heading starts a new card; its plain text is combined with the file name as front,
 *       and the content following it becomes the back.</li>
 * </ul>
 * </p>
 */
