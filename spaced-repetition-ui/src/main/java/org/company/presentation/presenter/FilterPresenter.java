...
public class FilterPresenter {
    ...
    public FilterPresenter(LoadDataUseCase loadDataUseCase, StreamingUseCase streamingUseCase, TaskView view) {
            ...
            protected void done() {
                try {
                    if (isCancelled()) {
                        ...
                        streamingUseCase.startStreaming(streamStart, new StreamingListener() {
                            @Override
